...
- [x] 02-03-PLAN.md — Premium/discount zones + zone/pool lifecycle state machine
...
- [x] 03-03: Walk-forward harness + per-window reports
...
- [x] 04-01-PLAN.md — Feature builder from SMC state + point-in-time feature audit (AI-01, Wave 1)
