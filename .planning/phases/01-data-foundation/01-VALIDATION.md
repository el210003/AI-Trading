...
- [ ] `tests/unit/` — five unit modules mapped to requirements: `test_normalize_and_config.py` (DATA-03), `test_idempotent_store.py` (DATA-04), `test_health_check.py` (DATA-01), `test_fetch_and_schedule.py` (DATA-02/03), plus `test_backfill.py` (DATA-04), `test_history_report.py` (DATA-05), `test_timezone_dst.py` (DATA-03)
